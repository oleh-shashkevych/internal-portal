...
`;
    ...
    `;
        ...
        function renderSelectedUsers() {
            ...
            // Добавляем или удаляем класс 'empty' в зависимости от количества выбранных сотрудников
            if (selectedEmployees.size === 0) {
                selectedUsersContainer.classList.add('empty');
            } else {
                selectedUsersContainer.classList.remove('empty');
            }
